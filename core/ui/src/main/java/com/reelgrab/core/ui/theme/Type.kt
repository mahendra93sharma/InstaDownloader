 ...
 *
 * Why Roboto and not Inter/Roboto Flex? Variable fonts ship as `.ttf` assets and bloat the
 * APK; we keep system default until brand finalises whether Inter is required. Swap in via
 * `res/font/inter_variable.ttf` + `FontFamily(...)` when ready — a follow-up note tracked
 * in ARCHITECTURE.md.
 */
private val Default = FontFamily.Default

val ReelGrabTypography = Typography(
